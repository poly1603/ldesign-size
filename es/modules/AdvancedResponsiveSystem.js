 ...
 * ***********************************
 */
import { getDeviceDetector } from '../core/DeviceDetector.js';

const containerQueryCleanups = /* @__PURE__ */ new WeakMap();
class AdvancedResponsiveSystem {
  constructor() {
    this.detector = getDeviceDetector();
...
export { AdvancedResponsiveSystem, createResponsiveSystem, responsive };
/*! End of @ldesign/size | Powered by @ldesign/builder */
//# sourceMappingURL=AdvancedResponsiveSystem.js.map
