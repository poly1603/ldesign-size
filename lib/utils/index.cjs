...
var memoryOptimizer = require('./memoryOptimizer.cjs');
var performanceDiagnostics = require('./performanceDiagnostics.cjs');
...
exports.benchmark = benchmark.benchmark;
exports.compareBenchmarks = benchmark.compareBenchmarks;
exports.runBenchmark = benchmark.runBenchmark;
exports.clearCache = lazyLoader.clearCache;
exports.createLazyProxy = lazyLoader.createLazyProxy;
exports.getCacheStatus = lazyLoader.getCacheStatus;
exports.lazyLoad = lazyLoader.lazyLoad;
exports.preload = lazyLoader.preload;
exports.setCacheLimit = lazyLoader.setCacheLimit;
exports.ExpiringCache = memoryOptimizer.ExpiringCache;
exports.ObjectAssociatedCache = memoryOptimizer.ObjectAssociatedCache;
exports.TieredCache = memoryOptimizer.TieredCache;
exports.WeakRefCache = memoryOptimizer.WeakRefCache;
exports.memoryOptimizer = memoryOptimizer.memoryOptimizer;
exports.PerformanceDiagnostics = performanceDiagnostics.PerformanceDiagnostics;
exports.perf = performanceDiagnostics.perf;
exports.perfDiagnostics = performanceDiagnostics.perfDiagnostics;
exports.addSizes = addSizes;
exports.batchProcessSizes = batchProcessSizes;
...
exports.optimizeCSSVariables = optimizeCSSVariables;
exports.parseSizeInput = parseSizeInput;
exports.requestIdleCallback = requestIdleCallback;
exports.roundSize = roundSize;
exports.scaleSize = scaleSize;
exports.subtractSizes = subtractSizes;
