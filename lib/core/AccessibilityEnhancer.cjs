...
class AccessibilityEnhancer {
  ...
  autoAdjustForA11y(level = "AA") {
    ...
    if (adjustedSize !== currentConfig.baseSize) {
      SizeManager.sizeManager.setBaseSize(adjustedSize);
  ...
  validateTouchTargets() {
    ...
    const minSize = DeviceDetector.getDeviceDetector().isTouch() ? 44 : 24;
...
exports.a11y = a11y;
exports.getAccessibilityEnhancer = getAccessibilityEnhancer;
