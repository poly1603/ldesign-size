...
class GamifiedSizing {
  constructor(config = {}) {
    ...
    this.animationSystem = new AnimationManager.AnimationManager();
...
exports.GamifiedSizing = GamifiedSizing;
exports.createGamifiedSizing = createGamifiedSizing;
/*! End of @ldesign/size | Powered by @ldesign/builder */
//# sourceMappingURL=GamifiedSizing.cjs.map
